...
class neuralNetwork:
    ...
    def __init__(self, inputnodes=784, hiddennodes=0, outputnodes=0, learningrate=0, reload_net=False):
        ...
        # when there's given a previous Net 
            ...
            self.wih = numpy.loadtxt(open('../save/' + reload_net + '/wih.csv',"rb"), delimiter=",", skiprows=0)
            self.who = numpy.loadtxt(open('../save/' + reload_net + '/who.csv',"rb"), delimiter=",", skiprows=0)
    ...
    def saveNetwork(self):
        ...
        numpy.savetxt(fold_name+"/wih.csv", self.wih, delimiter=',')
        numpy.savetxt(fold_name+"/who.csv", self.who, delimiter=',')
