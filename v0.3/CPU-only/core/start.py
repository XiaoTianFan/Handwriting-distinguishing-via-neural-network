...
-------------------------------------------------------------------------------------
GPU mode is unavailable in this version, please input CPU
...
''') == 'new': 
        if computing_method == 'GPU':
            print('this function is not available in this version, change to CPU mode automatically')
            computing_method = 'CPU'
        ...
        if computing_method == 'GPU':
            print('this function is not available in this version, change to CPU mode automatically')
            computing_method = 'CPU'
            Net = network_Definition_CPU.neuralNetwork(reload_net = input('''
-------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------
which set do you prefer?: mnist/CC10
