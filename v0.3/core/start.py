...
'''))
            ...
            input_reload_net = input('''your network fold should be saved in ../save
the parameters of your network should correspond to the parameters you have just inputed
...
''')
            while True:
                try:
                    Net = network_Definition_CPU.neuralNetwork(reload_net=input_reload_net)
                    break
                except:
                    reload_net = input('''
data set not avaliable
...
''')
        ...
        while True:
            try:
                ...
                testing_data_file = input('''
testing data set not avaliable, please input again

please input your testing_data_set file name:
''')
...
''')
        while True:
            try:
                ...
                testing_data_file = input('''
training data set not avaliable, please input again

please input your testing _data_set file name:
''')
...
''')
        ...
        while True:
            try:
                ...
                if training_epoch >= 5 and training_epoch <= 10:
                    break
                else:
                    training_epoch = input('''
-------------------------------------------------------------------------------------
please input between 5-10

''')
            except:
                training_epoch = input('''
-------------------------------------------------------------------------------------
please input a interger value
